...
if (!srcPath) {
    throw new Error('"globals.adminPath" is not defined. A file path to a Allincart 6 administration is required');
}

global.window._features_ = {};

const Allincart = require(resolve(join(srcPath, `src/core/allincart.ts`))).AllincartInstance;
